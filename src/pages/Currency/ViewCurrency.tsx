...
import { touchPageMeta } from '../../helpers/PageMeta';
...
const ViewCurrency = () => {
  ...
  return (
    <div className={`page-container ${theme}`}>
      <h2>Edit Currency</h2>
      <div className="form-meta-container" style={{ display: 'flex', justifyContent: 'space-between', gap: '20px' }}>
        <PageMetaBox type="currency" id={id!} />
        <div style={{ flex: 3 }}>
          {error && <div className="error-message">{error}</div>}
          
          {loading ? (
            <Spinner type='Currency'></Spinner>
          ) : currency ? (
