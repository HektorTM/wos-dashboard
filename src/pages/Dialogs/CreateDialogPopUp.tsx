...
import {CreateDialogPopupProps} from '../../types/Dialog.tsx'
import {useFlash} from "../../context/FlashContext.tsx";

const CreateDialogPopup = ({onClose, onCreate}: CreateDialogPopupProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                await createPageMeta('dialog', `${parseID(dialogId)}`, `${authUser?.uuid}`);
                onCreate({
                    dialog_id: dialogId,
                    char_name: character
                });
                setCreated(dialogId);
                addFlash(`Created Dialog '${dialogId}'`, "success");
            } else {
