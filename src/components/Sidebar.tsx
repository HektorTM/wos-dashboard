...
import {Category, SidebarProps} from "../types/Sidebar.tsx";
    ...
    const categories: Category[] = [
        ...
        },
        {
            ...
            subItems: [
                ...
                {id: 'globalstats', title: 'Global Stats', href: '/globalstats', permission: 'portal.globalstats.view'},
                ...
                {id: 'loottables', title: 'Loottables', href: '/loottables', permission: 'portal.loottables.view'},
            ...
            <div className={`sub-sidebar ${showSubSidebar ? 'visible' : 'hidden'}`}>
                ...
                <div className="sub-sidebar-content">
                    {activeCategory?.subItems.map((subItem) => (
                        <PermissionLink perm={subItem.permission ? subItem.permission : undefined}
                                        hasPermission={hasPermission} loading={loading}>
                            <a
                                key={subItem.id}
